namespace Picker
{
    ...
    internal partial class MemoryListView : Form, IMemoryListView
    {
        ...
        public int? MemoryMinCapacity => enableMinCapacityBox.Checked ? (int?)minCapacityBox.Value : null;

        public int? MemoryMaxCapacity => enableMaxCapacityBox.Checked ? (int?)maxCapacityBox.Value : null;

        public int? MemoryMinFrequency => enableMinFrequencyBox.Checked ? (int?)minFrequencyBox.Value : null;

        public int? MemoryMaxFrequency => enableMaxFrequencyBox.Checked ? (int?)maxFrequencyBox.Value : null;

        public decimal? MemoryMinPrice => enableMinPriceBox.Checked ? (int?)minPriceBox.Value : null;

        public decimal? MemoryMaxPrice => enableMaxPriceBox.Checked ? (int?)maxPriceBox.Value : null;
        ...
        public MemoryListView(MemoryListPresenter presenter)
        {
            ...
            compatiblesBox.Visible = newButton.Visible = false;
        ...
        private async void clearFilterButton_Click(object sender, EventArgs e)
        {
            ...
            enableMinPriceBox.Checked = enableMaxPriceBox.Checked = enableMinFrequencyBox.Checked =
                enableMaxFrequencyBox.Checked =
                    enableMinCapacityBox.Checked = enableMaxCapacityBox.Checked;
